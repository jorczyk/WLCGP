...
#         # dist, index2 = np.sort(mdist)
        ...
        dist = np.sort(mdist)
        # print index2 - jest w porzadku tylko sa diw trojki takich samych wartosci wiec moga wychodzic inne indexy
#
        class1 = int(np.math.floor(index2[1] / NumPerClassTrain - 0.1) + 2)  # NumPerClassTrain - skad to ma byc potem brane?
